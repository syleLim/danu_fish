...
# Main Script
class EX_CustomMesh_(Actor.Actor):
    def __init__(self):
        self._Time = 0.0
    ...
    def OnCreate(self, this):
        ...
        # Use Custom Shader
        self.CustomMesh.PropCustomMesh.SetVertexShader("/Assets/CustomShader") 
        self.CustomMesh.PropCustomMesh.SetPixelShader("/Assets/CustomShader")
        ...
        self.StaticMesh.AddData(posList[0], Math3d.Color(1, 0, 0, 0.5), Math3d.Vector2(0,1))    # 0
        self.StaticMesh.AddData(posList[3], Math3d.Color(1, 0, 0, 0.5), Math3d.Vector2(0.5,0))  # 1
        self.StaticMesh.AddData(posList[1], Math3d.Color(1, 0, 0, 0.5), Math3d.Vector2(1,1))    # 2

        self.StaticMesh.AddData(posList[1], Math3d.Color(0, 1, 0, 0.5), Math3d.Vector2(0,1))    # 3
        self.StaticMesh.AddData(posList[3], Math3d.Color(0, 1, 0, 0.5), Math3d.Vector2(0.5,0))  # 4
        self.StaticMesh.AddData(posList[2], Math3d.Color(0, 1, 0, 0.5), Math3d.Vector2(1,1))    # 5

        self.StaticMesh.AddData(posList[3], Math3d.Color(0, 0, 1, 0.5), Math3d.Vector2(0.5,0))  # 6
        self.StaticMesh.AddData(posList[0], Math3d.Color(0, 0, 1, 0.5), Math3d.Vector2(0,1))    # 7
        self.StaticMesh.AddData(posList[2], Math3d.Color(0, 0, 1, 0.5), Math3d.Vector2(1,1))    # 8

        self.StaticMesh.AddData(posList[2], Math3d.Color(1, 1, 1, 0.5), Math3d.Vector2(0,1))    # 9
        self.StaticMesh.AddData(posList[0], Math3d.Color(1, 1, 1, 0.5), Math3d.Vector2(0.5,0))  # 10
        self.StaticMesh.AddData(posList[1], Math3d.Color(1, 1, 1, 0.5), Math3d.Vector2(1,1))    # 11
        ...
        self.CustomMesh.SetTexture("TextureDiffuse", "$project/Assets/Texture.jpg")
